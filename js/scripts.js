...
$(document).ready(function() { //business logic does NOT need to be in doc.ready
  ...
  $("form#userInput").submit(function() {
    ...
    var translatedValue = singleVowelCheck(value); // takes the inputed string and runs it through the back-end function, with output being the new var translatedValue
